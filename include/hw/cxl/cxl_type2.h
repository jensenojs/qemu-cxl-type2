...
typedef struct CXLType2CommandScopeLedger {
  ...
  uint64_t stream_sync_elided_calls_by_reason[CXL_GPU_STREAM_SYNC_REASON_COUNT];
  uint64_t stream_sync_driver_calls_by_reason[CXL_GPU_STREAM_SYNC_REASON_COUNT];
  uint64_t
      stream_sync_driver_busy_ns_by_reason[CXL_GPU_STREAM_SYNC_REASON_COUNT];
...
bool cxl_type2_model_aperture_access(CXLType2State *ct2d, uint64_t offset,
                                     ...
                                     uint64_t *latency_ns, const char **reason);
